...
Another way to see this is to show the __Variance Explained__. This is done by simply squaring the __Standard Deviations__ of each principle component and divide them by the __Total variance__. 
